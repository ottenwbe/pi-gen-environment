require 'pi_build_environment/environment/vagrant_file'
require 'fileutils'
require 'pathname'
...
module PiCustomizer
  module Environment
    RSpec.describe VagrantFileRenderer do
      ...
      let(:vagrant_file) {VagrantFile.new}
      let(:vagrant_file_builder) {VagrantFileRenderer.new(vagrant_file)}

      it 'renders a valid file' do

        vagrant_file.root = "'envs/vagrant/'"
        vagrant_file.vagrant_path = 'envs/vagrant/'
